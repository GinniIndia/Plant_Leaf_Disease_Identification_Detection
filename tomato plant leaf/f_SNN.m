...
%  Diseases Analyzed: Tomato Plant Leaf
%  Author Name      : Ginni Garg, Mantosh Biswas 
%  E mail I.D       : gargginni01@gmail.com
%---------------------------------------------------------------------------------------

load output_tomato.mat;
load input_tomato.mat;
...
[val,idx]=max(y);
if idx==1
    disp("Disease:Bacterial_Spot")
  
elseif idx==2
        disp("Disease:Early_Blight")
        
elseif idx==3 
        disp("Disease:Late_Blight")
            
elseif idx==4
        disp("Disease:Septoria Disease")
                
else
        disp("Disease:Yellow_Virus")
end
