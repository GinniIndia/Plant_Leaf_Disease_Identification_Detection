...
%  Diseases Analyzed: General Diseases
%  Author Name      : Ginni Garg, Mantosh Biswas
%  E mail I.D       : gargginni01@gmail.com
%----------------------------------------------------------------------------------------------------------------------
%   hey - input data.
%   ff_outpupt - target data.
load general_output;
load general_input;
x = general_input';
t = general_output';
%Loading of Data is complete
...
%Various configuration of the Neurons in the Only hidden layer 
...
clc
if idx==1
    disp("Disease:Bacterial Leaf Spot")
  
elseif idx==2
        disp("Disease:Early Scorch")
        
elseif idx==3 
        disp("Disease:Frog eye leaf")
            
elseif idx==4
        disp("Disease:Alternaria Alternata(Fungal Disease)")
                
else
        disp("Disease:Sunburn Disease")
end
