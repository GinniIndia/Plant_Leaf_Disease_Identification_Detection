...
%  Diseases Analyzed: Apple Disease
%  Author Name      : Ginni Garg, Mantosh Biswas 
%  E mail I.D       : gargginni01@gmail.com
%---------------------------------------------------------------------------------------
% This script assumes these variables are defined:
%   hey_apple - input data.
%   apple_output - target data.
load input_apple.mat;
load output_elbow.mat;
...
[val,idx]=max(y);
if idx==1
    disp("Disease:Apple_Rot")
else
        disp("Disease:Apple_Rust")
end
